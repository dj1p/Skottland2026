...
export const trip2026: Trip = {
  ...
  schedule: [
    // TORSDAG 27. AUGUST
    {
      ...
      color: 'amber',
      activities: [
        { icon: '✈️', title: 'Fly fra Stavanger til Aberdeen', description: 'Sjekk flyavganger for eksakte tider' },
        { icon: '🚗', title: 'Kjør til Brechin (~55 minutter)', description: 'Hent leiebiler på Aberdeen Airport' },
    ...
    // FREDAG 28. AUGUST
    {
      ...
      courses: [
        ...
        },
        {
          ...
          designer: 'Harry Colt',
          greenfee: '£20-25',
          description: 'Kortere men utfordrende linksbane. Perfekt for 36 hull på en dag. Små, vanskelige greens.',
          distanceFromHouse: '~25 min',
          timeOfDay: 'afternoon',
        },
      ],
